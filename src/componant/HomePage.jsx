...
return (
  <>
    ...
    <TableContainer component={Paper} sx={{ minWidth: 250, maxWidth: 600,  background:'black', margin:{xs:'80px 0 0 0', sm:'0 0 0 300px'} }}>
    ...
    <Typography variant="h5" gutterBottom sx={{margin:'20px 0 0 0'}}>
         <Link to="/News" style={{textDecoration:'none', color:'orange'}}> Show More
          </Link>
    </Typography>
    </>
  );
